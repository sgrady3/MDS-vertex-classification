// g++ -m64 -std=c++11 -o essential-DS-no-orbits Graph.cpp essential-DS-no-orbits.cpp computeOrbits.cpp /home/stephen/code/nauty26r11/nauty.a -I /home/stephen/code/nauty26r11 -I /home/stephen/code/gurobi752/linux64/include/ -L /home/stephen/code/gurobi752/linux64/lib/ -lgurobi_c++ -lgurobi75 -lm
...
std::vector<std::vector<int> > createOrbits(std::vector<boost::dynamic_bitset<> >& bitsets, int num_edges)
{
    ...
    denseorbitSets=orbitSets=orbits(bitsets);
    ...
    cout<<"sparse orbit size: "<<orbitSets.size()<<"\n";
    cout<<"dense orbits size: "<<denseorbitSets.size()<<"\n";
    return orbitSets;
}
...
int main(int argc, char const *argv[])
{
    ...
    //start=std::chrono::system_clock::now();
    //classes.orbits=createOrbits(bitsets,g.numEdges());
    //end=std::chrono::system_clock::now();
    ...
    for (int i = 0; i < numV; ++i)
    {
        ...
        {
            if(essentialRule2(classes,bitsets,g,i))
            {
